...
# 대시보드 UI 구성
def render_device2_dashboard():
    serial_no = 'ICW0W2001048'
    ...
    with left_col:
        ...
        with col1:
            st.markdown("<h1 style='text-align: left;'>ACE HALL</h1>", unsafe_allow_html=True)
        with col2:
            if st.button("🏠 홈으로"):
        ...
        # 자세히 보기 버튼
        if st.button("🔍 자세히 보기"):
            st.session_state.page = "detailed_view02"
            st.rerun()
